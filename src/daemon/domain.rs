...
pub struct NormalizedCommand {
    ...
    /// Effective transport destination observed in trace2 after Git resolves a remote.
    /// This is captured while the command is running so deferred processing never has
